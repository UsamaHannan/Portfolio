        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Transforming design mockups into pixel-perfect, highly responsive, and interactive frontend applications utilizing modern tools and clean code architectures.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Three.js / GSAP</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Creating user-centric interface designs, structural wireframes, and design systems. Crafting interactive 3D assets and animations to elevate digital experiences.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
